            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 4:
                        _c = user.password;
                        _f.label = 5;
                    case 5: return [4 /*yield*/, _b.apply(_a, [(_d.data = (_e.password = _c,
                        ...
                        favoriteType = type === "song"
                            ...
                            : type === "album"
                                ...
                                : type === "artist"
                                    ? "favoritesArtist"
                                    : "favoritesPlaylist";
                        isFavorite = user[favoriteType].some(function (item) { return item.id === +id; });
