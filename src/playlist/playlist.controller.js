...
var PlaylistController = /** @class */ (function () {
    ...
    PlaylistController.prototype.getPlaylistById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.playlistService.getPlaylistById(id)];
            });
        });
    };
    __decorate([
    ...
    ], PlaylistController.prototype, "getPlaylistById");
